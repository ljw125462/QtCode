...
void StuModifyPassSelf::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StuModifyPassSelf *_t = static_cast<StuModifyPassSelf *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (StuModifyPassSelf::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StuModifyPassSelf::backToStuScreen)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject StuModifyPassSelf::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StuModifyPassSelf.data,
      qt_meta_data_StuModifyPassSelf,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StuModifyPassSelf::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StuModifyPassSelf.stringdata0))
        return static_cast<void*>(const_cast< StuModifyPassSelf*>(this));
