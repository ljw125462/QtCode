...
#include "../../mine_sweeping/dialog_2.h"
...
QT_MOC_LITERAL(1, 9, 5), // "getsz"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 5), // "setsz"
QT_MOC_LITERAL(4, 22, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(5, 44, 23) // "on_pushButton_2_clicked"

    },
    "Dialog_2\0getsz\0\0setsz\0on_pushButton_clicked\0"
...
void Dialog_2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getsz((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->setsz((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            using _t = void (Dialog_2::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog_2::getsz)) {
                *result = 0;
                return;
            }
        }
