...
QT_MOC_LITERAL(1, 6, 19), // "SignalSendChessData"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 1), // "i"
QT_MOC_LITERAL(4, 29, 1) // "j"

    },
    "Chess\0SignalSendChessData\0\0i\0j"
};
...
void Chess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalSendChessData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Chess::SignalSendChessData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Chess::SignalSendChessData(int _t1, int _t2)
{
