...
void StuScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StuScreen *_t = static_cast<StuScreen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (StuScreen::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StuScreen::backToLoginScreen)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject StuScreen::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StuScreen.data,
      qt_meta_data_StuScreen,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StuScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StuScreen.stringdata0))
        return static_cast<void*>(const_cast< StuScreen*>(this));
