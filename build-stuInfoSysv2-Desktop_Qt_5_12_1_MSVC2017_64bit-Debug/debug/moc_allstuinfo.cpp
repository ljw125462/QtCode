...
void AllStuInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AllStuInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AllStuInfo::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AllStuInfo::backToAdminScreen)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AllStuInfo::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AllStuInfo.data,
    qt_meta_data_AllStuInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
