...
void AdminScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AdminScreen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AdminScreen::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AdminScreen::backToLoginScreen)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AdminScreen::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AdminScreen.data,
    qt_meta_data_AdminScreen,
    qt_static_metacall,
    nullptr,
    nullptr
} };
